...
public class OrzQQBotWsMultipleSetupTest {
    static class CountingWs implements WsClient {
    ...
    static class CountingFactory implements WebSocketClientFactory {
        final CountingWs ws = new CountingWs();
